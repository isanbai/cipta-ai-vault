...
| copy()           | The `copy()` method is used to create a shallow copy of a list.                                                                                                                                                                                             | Example 1:<br><br>`my_list = [1, 2, 3, 4, 5]` <br>`new_list = my_list.copy() print(new_list)` <br>`# Output: [1, 2, 3, 4, 5]`                                                                                                                                                                                                                                                                                                                                                                                                                                            |
